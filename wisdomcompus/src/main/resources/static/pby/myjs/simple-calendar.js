      ...
      if (options.showMark) {
        ...
        if (data) {
          daysElement.forEach(function (v, i) {
            ...
            if (data[year + '-' + currentmonth + '-' + day] === "迟到") {
            	
              v.classList.add('sc-mark1');
              v.title = data[year + '-' + currentmonth + '-' + day];
            }else if(data[year + '-' + currentmonth + '-' + day] == "早退") {
            	v.classList.add('sc-mark2');
              v.title = data[year + '-' + currentmonth + '-' + day];
            }else if(data[year + '-' + currentmonth + '-' + day] == "迟到并早退") {
            	v.classList.add('sc-mark3');
              v.title = data[year + '-' + currentmonth + '-' + day];
            }else if(data[year + '-' + currentmonth + '-' + day] == "请假") {
            	v.classList.add('sc-mark4');
              v.title = data[year + '-' + currentmonth + '-' + day];
            }else if(data[year + '-' + currentmonth + '-' + day] == "旷课") {
            	v.classList.add('sc-mark5');
              v.title = data[year + '-' + currentmonth + '-' + day];
            }else {
              v.classList.remove('sc-mark1');
              v.classList.remove('sc-mark2');
              v.classList.remove('sc-mark3');
              v.classList.remove('sc-mark4');
              v.classList.remove('sc-mark5');
              v.title = '';
            }
          });
        }
...
SimpleCalendar.prototype.languageData = {
  ...
  vocation: {
  	...
  	data_2019: ['1-1', '1-2', '1-3', '2-7', '2-8', '2-9', '2-10', '2-11', '2-12', '2-13', '4-2', '4-3', '4-4', '4-30', '5-1', '5-2', '6-9', '6-10', '6-11', '9-15', '9-16', '9-17',, '10-1', '10-2', '10-3', '10-4', '10-5', '10-6', '10-7']
  }
};
